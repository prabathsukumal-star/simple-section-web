...
const CreateParentForm = ({ onSubmit, onCancel, initialData }: CreateParentFormProps) => {
  ...
  const [formData, setFormData] = useState({
    ...
    dateOfBirth: initialData?.user?.dateOfBirth ? dayjs(initialData.user.dateOfBirth) : null,
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <Label htmlFor="nic" className="text-base font-medium">NIC (must be unique)</Label>
              <Input
                id="nic"
                value={formData.nic}
            ...
            <div>
              <Label htmlFor="birthCertificateNo" className="text-base font-medium">Birth Certificate No (must be unique)</Label>
              <Input
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="text-xl">Professional & Address Information</CardTitle>
          </CardHeader>
          <CardContent className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                ...
                />
                <Label htmlFor="isActive" className="text-base font-medium">Active Account</Label>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="flex justify-end space-x-6 pt-6 border-t">
        <Button type="button" variant="outline" onClick={onCancel} className="px-8 py-3 text-base">
          Cancel
        </Button>
