  ...
  useEffect(() => {
    if (subject && open) {
      form.reset({
        ...
        subjectType: subject.subjectType || SubjectType.MAIN,
        basketCategory: subject.basketCategory || BasketCategory.COMMON,
        instituteType: subject.instituteType || InstituteType.SCHOOL,
      });
      setImagePreview(subject.imgUrl || null);
      setImageFile(null);
    }
  }, [subject, open, form]);
